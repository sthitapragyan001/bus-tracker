...
const JourneySoFar = () => {
  const stages = [
    {
      title: "Stage 1: Idea Conceptualization",
      description:
    ...
    {
      title: "Stage 2: Research & Planning",
      description:
    ...
    {
      title: "Stage 3: Setting up Backend",
      description:
    ...
    {
      title: "Stage 4: Building the Frontend",
      description:
    ...
    {
      title: "Stage 5: Testing & Refinement",
      description:
    ...
    {
      title: "Stage 6: Future Improvements",
      description:
